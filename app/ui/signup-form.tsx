...
export default function SignUpForm() {
  const [state, dispatch] = useFormState(signUpUser, {message: '', errors: {}});
      ...
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
        ...
        <div className="w-full">
          <div>
            ...
            <div id="signup-email-error" aria-live="polite" aria-atomic="true">
              {state.errors?.email &&
          ...
          <div>
            ...
            <div id="signup-username-error" aria-live="polite" aria-atomic="true">
              {state.errors?.name &&
        ...
        >
          {state.message && (
            <>
              ...
              <div className=""><p className='text-sm text-red-500'>{state.message}</p></div>
            </>
          )}
        </div>
      </div>
